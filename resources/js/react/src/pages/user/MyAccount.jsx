...
import { GradingRounded, FavoriteBorderRounded, ShoppingCartOutlined, AlarmRounded, LogoutRounded, CloseRounded, WorkspacePremiumOutlined } from '@mui/icons-material';
import Address from "./UserInfo/Address/Address";
import PasswordChange from "./UserInfo/PasswordChange";
...
function MyAccount() {
    ...
    const couponApply = (e) => {
        console.log("Kupon Kodu:", e.target.value);
    }
                            ...
                            >
                                ...
                                >
                                    <div className="myaccount-details">
                                        <PasswordChange user={currentUser} />
                                    </div>
                                </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="quantity">
                                                                            ...
                                                                            <div className="cart-plus-minus">
                                                                                <input readOnly className="cart-plus-minus-box" value={count} type="text" />
                                                                                <div type="button" className="dec qtybutton" onClick={() => count > 1 && setCount(count - 1)}><i className="fa fa-angle-down"></i></div>
                                                                                <div type="button" className="inc qtybutton" onClick={() => setCount(count + 1)}><i className="fa fa-angle-up"></i></div>
                                                                            </div>
                                                                        </td>
                                                            ...
                                                            <div className="col-12">
                                                                <div className="coupon-all">
                                                                    <div className="coupon">
                                                                        <input id="coupon_code" className="input-text" onChange={couponApply} name="coupon_code" value="" placeholder="Kupon Kodu" type="text" />
